...
$(function() {
	$("#edit").click(function() {
		...
		document.form1.action = "${path}/memberlist_servlet/userEdit.do";
    ...
    <div class="col-sm-8 text-left" style="padding-top: 25px;">
			<form method="post" name="form1">
				<table>
					<tr>
						<td>아이디</td>
						<td colspan="2">${ dto.userid }<input type="hidden" name="userid" id="userid" value="${ dto.userid }"></td>
					</tr>
					<tr>
						<td>비밀번호</td>
					...
					<tr>
						<td>이메일</td>
						<td colspan="2"><input type="text" id="email" name="email" value="${ dto.email }"></td>
					</tr>
					<tr>
						<td></td>
						<td colspan="2" style="text-align: right;"><input type="button" value="등록하기" id="edit"></td>
					</tr>
				</table>
			</form>
    </div>
